...
[^1]: You don't need to know this now, but the name `BernGrid()` 
...
and comment the big idea(s) illusrated by this comparison.

    ```{r, BernGrid-01, eval = FALSE, message = FALSE}
    library(CalvinBayes)
...
and comment the big idea(s) illusrated by this comparison.
    ...
    ```{r, BernGrid-02, eval = FALSE, message = FALSE}
    library(CalvinBayes)
