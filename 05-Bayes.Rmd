...
1001 grid points from 0 to 1 by 0.001.[^1]

[^1]: There are other ways to do this, but `expand.grid()` will work
...
So we have updated our belief from a 0.1% chance the person has the disease to a
4.7% chance that they have the disease. That's a sizable increase, but the
