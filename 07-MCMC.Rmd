...
how often must King Markov harbor at each island?
...
Metropolis devises the following scheme:
  ...
  * Before leaving, inquire about the population of the current island.
  
  * When arriving at the proposal island, inquire about its population.
  ...
  probability $R$, else return to the "current" island (ie, last night's island).
...
If $R$ is between 0 and 1, and the jumping rule allows us to get to all the
