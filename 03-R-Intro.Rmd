...
For more detailes see <http://adv-r.had.co.nz/Style.html>, on which this is based.
...
5. **Choose names wisely and consistently**.
    ...
    good_name <- 10
    good.name <- 10
    goodName  <- 10    # not alignment via extra space in this line
...
7. **Excpetions** should be exceptional.
...
### An additional note about homwork
...
restults returned. (Such functions are called **vectorized**.)
...
If you type the name of a function witout parenthesis, you will see all three
parts listed:
