...
if $p(x,y)$ is a continuous joing pdf.
...
10. Use the definitions above to express indendence another way.
...
$[0,1]$.  (That means it is 0 outside of that interval.)
    a.  Use `function()` to create a function in R that is equivlent to `p(x)`.
